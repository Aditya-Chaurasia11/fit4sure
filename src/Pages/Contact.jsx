...
const Contact = () => {
  const handleSubmit = (e) => {
    e.preventDefault();
    toast.info("Our team will get back to you within 24 hours")
  };



  return (
    <div className="contact_upper_container">
      <div className="contact_container">
        <div className="contact_container_card">
          <h1>
            Contact <span>Us</span>
          </h1>
          <div className="contact_container_card_input">
            <label>Name</label>
          ...
          <div>
            <div className="contact_container_button">
              <button className="first_button" onClick={handleSubmit}>
                Submit
              </button>
            </div>
          </div>
