...
const Career = () => {
  return (
    <div className="career_upper_container">
      <div className="career_container">
        <div className="career_container_card">
          <h1>
            Join <span>Us</span>
          </h1>
          <div className="career_container_input">
            <input type="text" placeholder="search roles"></input>
            <select>
              <option>All</option>
            </select>
          </div>

          <div className="career_container_card_cardComp">
            <div className="career_container_card_cardComp_div">
