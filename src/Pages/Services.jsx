...
const Services = () => {
  return (
    <div className="services_upper_container">
      <div className="services_container">
        <div className="services_container_card">
          ...
          <ReadMore
            ...
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu
            feugiat pretium nibh ipsum consequat. Felis imperdiet proin Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu
            feugiat pretium nibh ipsum consequat. Felis imperdiet proin Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu
            feugiat pretium nibh ipsum consequat. Felis imperdiet proin"
      ...
      <img className="services_container_main_img" src={mainImg}></img>
      <div className="services_container_svg">
        <svg
          height="403"
