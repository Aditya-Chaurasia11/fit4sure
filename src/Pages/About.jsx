    ...
    <div className="about_upper_container">
      <div className="about_container">
        <div className="about_container_card">
          ...
          <p className="about_middle">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu
            feugiat pretium nibh ipsum consequat. Felis imperdiet proin
            fermentum leo vel orci porta. Fit4Sure pulvinar neque laoreet
            suspendisse. Neque convallis a cras semper auctor neque vitae.
            ...
            urna nec tincidunt praesent. Vulputate enim nulla aliquet porttitor
            lacus luctus. Netus et malesuada fames ac turpis egestas sed.
            Sollicitudin ac orci phasellus egestas tellus cursus metus aliquam
            eleifend mi in. Scelerisque eu ultrices vitae auctor eu augue ut
            lectus. Sit amet facilisis magna etiam tempor orci. Viverra
            adipiscing at in tellus integer. Dictum fusce ut placerat orci
            nulla. Volutpat odio facilisis mauris sit amet. Blandit Pretium
            lectus quam id leo. 
          </p>
          {/* <div> */}
            <div className="about_container_button">
              <button className="about_first_button">Contact Us</button>
            </div>
          {/* </div> */}
        </div>
      </div>
